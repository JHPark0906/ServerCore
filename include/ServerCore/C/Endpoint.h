...
extern "C" {
#endif
enum { SC_IP_UNSPECIFIED = 0, SC_IP_V4 = 4, SC_IP_V6 = 6 };
...
SC_API sc_status sc_ip_endpoint_parse(sc_bytes address,uint16_t port,sc_ip_endpoint* out);
...
SC_API sc_status sc_ip_endpoint_format(const sc_ip_endpoint*,char* buffer,size_t capacity,size_t* written);
#ifdef __cplusplus
}
#endif
#endif
